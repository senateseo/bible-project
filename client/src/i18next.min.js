            ...
            value: function (e, n) {
              ...
              if (
                ...
                if (j || R || N) {
                  ...
                  var C = [],
                    P = this.languageUtils.getFallbackCodes(
                      this.options.fallbackLng,
                      n.lng || this.language
                    );
                  if ("fallback" === this.options.saveMissingTo && P && P[0])
                    for (var E = 0; E < P.length; E++) C.push(P[E]);
                  else
            ...
            value: function (e, t, n, o) {
              ...
              if (this.i18nFormat && this.i18nFormat.parse)
                ...
                this.options.interpolation.defaultVariables &&
                  (a = r({}, this.options.interpolation.defaultVariables, a)),
              ...
              for (s = 0; (i = this.regexp.exec(e)); ) {
                if (void 0 === (a = f(i[1].trim())))
                  ...
                  "string" == typeof a ||
                    ...
                    (a = y(a));
                if (
                  ((a = this.escapeValue ? c(this.escape(a)) : c(a)),
                  (e = e.replace(i[0], a)),
      ...
      a(t, [
        ...
        },
        {
          ...
          value: function (e, t, n, o, i) {
            ...
            this.backend &&
              this.backend.create &&
              this.backend.create(e, t, n, o, null, r({}, a, { isUpdate: i })),
      ...
      a(n, [
        ...
        },
        {
          ...
          value: function (e, n) {
            ...
            return (
              "string" == typeof e ? (i.lng = e) : (i.lngs = e), (i.ns = n), i
            );
          },
        },
        {
